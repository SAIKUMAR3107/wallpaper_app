              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(color:Provider.of<ThemeProvider>(context, listen: false).isDarkMode ? Colors.black87 : Colors.deepPurple.shade200)),
                  ...
                  prefixIconColor: Provider.of<ThemeProvider>(context, listen: false).isDarkMode ? Colors.black87 : Colors.deepPurple.shade200,
                  suffixIconColor: Provider.of<ThemeProvider>(context, listen: false).isDarkMode ? Colors.black87 : Colors.deepPurple.shade200,
                ),
              ),
            ),
            SizedBox(height: 10,),
            Expanded(child: !noImage ? Center(child: Text("Search For Image"),): GridView.builder(
